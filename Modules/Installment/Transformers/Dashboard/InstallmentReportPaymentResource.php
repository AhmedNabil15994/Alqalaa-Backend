...
class InstallmentReportPaymentResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'user' => $this->user ? ( $this->pay_by_type == 'by_admin' ? __("installment::dashboard.installments.btn.by_admin") : '') . "({$this->user->name})" 
            : __('installment::dashboard.installments.btn.by_client'),
