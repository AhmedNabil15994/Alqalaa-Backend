        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    order: [[1, "desc"]],
                    columns: [
                        {data: 'id', className: 'text-center',responsivePriority: 1},
                        {data: 'id', className: 'text-center',responsivePriority: 1},
                        {data: 'title', className: 'text-center', orderable: false,responsivePriority: 1},
                        {data: 'description', className: 'text-center',responsivePriority: 1},
                        {
                            data: "model", className: 'text-center', orderable: false,responsivePriority: 1,
                        ...
                        {
                            data: "user", className: 'text-center', orderable: false,responsivePriority: 1,
                            render: function (data, type, full, meta) {
                        ...
                        {data: 'created_at', className: 'text-center',responsivePriority: 1},
                    ],
                    columnDefs: [
                        {
                            targets: 0,
