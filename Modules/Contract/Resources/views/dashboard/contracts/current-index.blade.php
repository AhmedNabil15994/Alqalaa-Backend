...
@section('title', __('contract::dashboard.contracts.routes.current-index'))
@section('css')
    <style>
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('contract::dashboard.contracts.routes.current-index')}}</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">
                                                {{__('contract::dashboard.contracts.routes.current-index')}}
                                            </span>
                            </div>
                        </div>
...
@section('scripts')
    @include('contract::dashboard.contracts.components.table',['datatable_url' => route('dashboard.current-contracts.datatable'),'exportStatus' => 'current'])
@stop
