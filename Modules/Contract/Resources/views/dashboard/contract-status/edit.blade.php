...
@section('title', __('contract::dashboard.contract-status.routes.update'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('contract::dashboard.contract-status.routes.update')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            {!! Form::model($model,[
                        'url'=> route('dashboard.contract-status.update',$model->id),
                        'id'=>'updateForm',
                        'role'=>'form',
                        'page'=>'form',
