...
@section('title', __('contract::dashboard.contract-types.routes.create'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('contract::dashboard.contract-types.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            {!! Form::model($model,[
                            'url'=> route('dashboard.contract-types.store'),
                            'id'=>'form',
                            'role'=>'form',
                            'method'=>'POST',
