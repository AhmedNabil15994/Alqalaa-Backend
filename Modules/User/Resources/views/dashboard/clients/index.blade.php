...
@section('title', __('user::dashboard.clients.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('user::dashboard.clients.routes.index')}}</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('user::dashboard.clients.datatable.name')}}</th>
                                    <th>{{__('user::dashboard.clients.datatable.email')}}</th>
                                    <th>{{__('user::dashboard.clients.datatable.phone')}}</th>
                                    <th>{{__('user::dashboard.clients.datatable.national_ID')}}</th>
                                    <th>{{__('user::dashboard.clients.datatable.state')}}</th>
                                    <th>{{__('Labels')}}</th>
                                    <th>{{__('user::dashboard.clients.datatable.created_at')}}</th>
                                    <th>{{__('user::dashboard.clients.datatable.is_judging')}}</th>
                                    <th>{{__('user::dashboard.clients.datatable.status')}}</th>
                                    <th>{{__('user::dashboard.clients.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
...
@section('scripts')
    @include('user::dashboard.clients.components.table')
