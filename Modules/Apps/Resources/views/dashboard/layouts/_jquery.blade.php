...
{{--<script src="{{asset('admin/js/plugins/global/plugins.bundle.js')}}"></script>--}}
...
<script src="/admin/assets/global/plugins/sweetalert/sweetalert.min.js" type="text/javascript"></script>
