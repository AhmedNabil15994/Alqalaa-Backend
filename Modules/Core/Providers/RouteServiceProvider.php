...
abstract class RouteServiceProvider extends ServiceProvider
{
    ...
    {
        return '\Modules\\' . $this->module_name . '\\Http\Controllers\Client';
    }
    ...
    protected function getClientRoutes(): array
    {
        ...
        if(count($this->client)){
            ...
            foreach ($this->client as $file){

                $routes[module_path($this->module_name, 'Routes/client') .'/'.$file] = $this->ClientGroups();
            }
        }
    ...
    public function map(Router $router)
    {
        ...
        $router->group(['namespace' => $this->getClientNameSpace()], function (Router $router) {
            $this->loadClientRoutes($router);
        });
    }
     ...
     * @param Router $router
     */
    private function loadClientRoutes(Router $router)
    {
        $routes = (array)$this->getClientRoutes();
        $this->requireRoutesFiles($router,$routes);
    }
